...
namespace WindowsFormsApplication {
	public partial class EmployeeListForm : DevExpress.XtraBars.Ribbon.RibbonForm {
		...
		private void EmployeeListForm_Load(object sender, EventArgs e) {
			...
			employeeGrid.DataSource = securedObjectSpace.CreateCollection(typeof(Employee), null, null);
        ...
        private void DetailForm_FormClosing(object sender, FormClosingEventArgs e) {
			EFCoreCollection collection = (EFCoreCollection)employeeGrid.DataSource;
            collection.Reload();
        }
